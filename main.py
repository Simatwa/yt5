...
if __name__=='__main__':
	...
	parser.add_argument('--show',action='store_true',help='Show the downloaded file-path')
	parser.add_argument('--static',action='store_true',help='Restricts printing of downloaded file-name in prose-format')
	parser.add_argument('--usage',action='store_true',help='Show this help info in more stylistic way')
